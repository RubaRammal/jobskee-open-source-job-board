...
<div class="row">
  ...
  <div class="col-md-12">
      ...
      <form  role="form" action="<?php _e(BASE_URL); ?>jobs/review" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
        <label for="job-logo" class="col-sm-3 control-label input-lg"><?php echo $lang->t('jobs|logo'); ?></label>
            <div class="col-sm-12 col-md-8">
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="job-logo" name="logo">
