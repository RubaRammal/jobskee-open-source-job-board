          ...
          <ul class="nav navbar-nav">
            ...
            <?php if(reqularUserIsValid()): ?>
                <?php if(isset($_SESSION['permission']) && $_SESSION['permission']['jobPoster'] == True): ?>
                  <li><a href="<?php _e(USER_URL .'jobs/new'); ?>"><?php echo $lang->t('jobs|post_job'); ?></a></li>
                <?php elseif(isset($_SESSION['permission']) && $_SESSION['permission']['jobApplicant'] == True): ?>
              <?php endif ?>
              <li><a href="<?php _e(USER_URL .'applications'); ?>"><?php echo $lang->t('apply|applications'); ?></a></li>
            <li class="dropdown">
            ...
            <?php if (userIsValid()): ?>
              ...
              <?php endif; ?>
              <li><a href="<?php _e(USER_URL .'profile'); ?>"><?php echo $lang->t('user|welcome') .' '. $_SESSION['username']; ?></a></li>
              <li><a href="<?php _e(USER_URL .'logout'); ?>"><?php echo $lang->t('link|logout'); ?></a></li>
            <?php else: ?>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $lang->t('options|text_options'); ?> <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="<?php _e(ADMIN_URL .'login'); ?>"><?php echo $lang->t('link|login'); ?></a></li>
                  <li><a href="<?php _e(USER_URL .'login'); ?>"><?php echo $lang->t('link|user_login'); ?></a></li>
                </ul>
              </li>
            <?php endif; ?>
          </ul>
